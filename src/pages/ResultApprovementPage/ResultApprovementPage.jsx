...
const rows = [
    createData("Burak Keçeci", "Computer Engineering", 3),
    createData("Malik Hinwani", "Bomputer Enginnering", 1),
    createData("Çağın Tunç", "Domputer Enginnering", 4),
    createData("Melih Çakmak", "Xomputer Enginnering", 2),
    createData("Sude Nur Çevik", "Komputer Enginnering", 3),
    createData("Serdar Sertgöz", "Fomputer Enginnering", 4)
];
...
export default function ResultApprovementPage() {
    ...
    const handleDocumentClick = async (event, name, docId) => {
        try {
            const res = await resultService.getDocumentOfUser(name, docId);
            console.log(res);
            if (res) {
                // Item deleted successfully
                window.location.reload();
                            ...
                            {visibleRows.map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="right">{row.departmantName}</TableCell>
